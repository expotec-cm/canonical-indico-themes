...
function buildHeaderStrip() {
  ...
  headerLogo.src = "https://192.168.1.16/event/1/images/1-Simbol_00_white_BG.png"
  headerLogoCont.append(headerLogo);

  const headerTitle = document.createElement("h1");
  headerTitle.innerText = "1ª semana de tecnologia";

  const headerSubtitle = document.createElement("h2");
  headerSubtitle.classList.add("headerSubtitle");
  headerSubtitle.innerText = " 24-26 de Janeiro de 2022";
